...
//     Explain in your own words how you understand what an event handler is
// In programming, an event is an action that occurs as a result of the user or another source,
// such as a mouse being clicked, or a key being pressed.
// An event handler is a routine that is used to deal with the event, allowing a programmer
// to write code that will be executed when the event occurs.